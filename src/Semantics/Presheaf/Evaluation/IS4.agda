...
import Semantics.Presheaf.Necessity C _⩽_ ⩽-refl ⩽-trans _R_ factor1 factor1-pres-id factor1-pres-∘ factor2 factor2-pres-id factor2-pres-∘ factor2-factor1 factor1-factor2 as PresheafNecessity
