...
private
  factor1PresId : ∀ (r : Γ R Δ') → factor1 idWk r ≡ (-, r , idWk)
  factor1PresId = {!!}

  factor1Pres∙ : ∀ (w : Γ ⊆ Γ') (w' : Γ' ⊆ Γ'') (r : Γ'' R Δ'') → factor1 (w ∙ w') r ≡ (-, factor1R w (factor1R w' r) , factor1⊆ w (factor1R w' r) ∙ factor1⊆ w' r)
  factor1Pres∙ = {!!}
...
module PresheafEvaluationIS4 = Semantics.Presheaf.Evaluation.IS4
                                 Ctx
                                 _⊆_ _∙_ (λ w w' w'' → ≡-sym (assocWk w w' w'')) idWk leftIdWk rightIdWk
                                 _R_ R-trans R-trans-assoc R-refl R-refl-unit-left R-refl-unit-right
                                 factor1 factor1PresId factor1Pres∙
                                 factor2 factor2PresId factor2Pres∙ factor2-pres-refl factor2-pres-trans
